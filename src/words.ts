...
export const categories: Category[] = [
  ...
  { id: 'fruit', label: 'Fruit & extras', short: 'Fruit', emoji: '🍎', tint: '#3a2018' },
  { id: 'food', label: 'Meals', short: 'Meals', emoji: '🍽️', tint: '#3a2418' },
  { id: 'drinks', label: 'Drinks & sweets', short: 'Drinks', emoji: '☕', tint: '#301c14' },
  { id: 'animals', label: 'Pets & farm', short: 'Pets', emoji: '🐶', tint: '#243018' },
  { id: 'wild', label: 'Wild animals', short: 'Wild', emoji: '🦁', tint: '#2a2814' },
  { id: 'creatures', label: 'Sea & small animals', short: 'Sea', emoji: '🐙', tint: '#182830' },
  { id: 'transport', label: 'Transport', short: 'Transport', emoji: '🚗', tint: '#1a2430' },
  { id: 'city', label: 'City places', short: 'Places', emoji: '🏙️', tint: '#1c2030' },
  { id: 'streets', label: 'Streets & travel', short: 'Streets', emoji: '🛣️', tint: '#182028' },
  { id: 'people', label: 'Family', short: 'Family', emoji: '👪', tint: '#3a2820' },
  { id: 'relatives', label: 'Friends & family', short: 'Friends', emoji: '🤝', tint: '#32241c' },
  ...
  { id: 'accessories', label: 'Accessories', short: 'Extras', emoji: '👜', tint: '#282030' },
  { id: 'grooming', label: 'Personal items', short: 'Personal', emoji: '💄', tint: '#302028' },
  { id: 'weather', label: 'Weather', short: 'Weather', emoji: '🌧️', tint: '#1c242c' },
  { id: 'nature', label: 'Land & water', short: 'Land', emoji: '🌿', tint: '#1c2c18' },
  { id: 'seasons', label: 'Seasons & places', short: 'Seasons', emoji: '🍂', tint: '#242818' },
  { id: 'actions', label: 'Daily actions', short: 'Daily', emoji: '🚶', tint: '#242018' },
  { id: 'doing', label: 'Doing things', short: 'Doing', emoji: '🛠️', tint: '#282418' },
  { id: 'mind', label: 'Mind & talk', short: 'Mind', emoji: '💭', tint: '#201c24' },
  { id: 'descriptions', label: 'Feelings', short: 'Feelings', emoji: '😊', tint: '#302028' },
  { id: 'size', label: 'Size & time', short: 'Size', emoji: '📏', tint: '#282020' },
